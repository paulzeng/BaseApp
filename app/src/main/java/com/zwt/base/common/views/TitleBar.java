package com.zwt.base.common.views;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    public void setTitle(int leftId, String leftText, String centerText, int rightId, String rightText,
        ...
        if (!TextUtils.isEmpty(rightText)) {
            ...
            rightTextView.setTextColor(getResources().getColorStateList(R.color.black));
    ...
    public void setTitle2(int leftId, String leftText, String centerText, int rightId, String rightText,
                          final OnClickListener leftOnclick, final OnClickListener rightOnclick) {
        //this.setImmersive(true);
